			...
			<KeepAlive>
				<div className="mb-32 flex flex-col items-center justify-center">
					<div className="mt-40 flex w-1/2 flex-col items-center justify-center rounded-3xl bg-gray-700 pt-16 pb-16">
						...
						<h4 className="mt-1 text-center text-gray-200">The saved 2FA names will show up. You can copy it after clicking it.</h4>
						...
						<div className="flex flex-col items-center justify-center">
							<h3>Clear data</h3>
							<h4 className="mt-1 text-center text-gray-200">Clear all app data including settings and saved codes.</h4>
						...
						<div className="flex flex-col items-center justify-center">
							<h3>Version</h3>
							<h4 className="ver mt-1 text-2xl text-gray-200"></h4>
